...
// NLBLoadBalancerTarget returns target container and target port for the NLB configuration.
func (s *LoadBalancedWebService) NLBLoadBalancerTarget() (targetContainer *string, targetPort *string, err error) {
