...
func (d *backendSvcDeployer) validateALBRuntime() error {
	if d.backendMft.RoutingRule.MainRoutingRule.IsEmpty() {
		return nil
	}

	if err := d.validateALBRuntimeFor(d.backendMft.RoutingRule.MainRoutingRule); err != nil {
...
func (d *backendSvcDeployer) validateALBRuntimeFor(rule manifest.ALBRoutingRule) error {
